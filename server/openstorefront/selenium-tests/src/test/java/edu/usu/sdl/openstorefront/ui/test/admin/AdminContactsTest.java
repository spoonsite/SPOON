		...
		extends AdminTestBase
{
	...
	@Test
	public void adminContactsTest()
	{
		for (WebDriver driver : webDriverUtil.getDrivers()) {

			setup(driver);
			createContact(driver, "TesterFirst", "TesterLast", "cameron.cummings@sdl.usu.edu");
	...
	public void createContact(WebDriver driver, String fName, String LName, String email)
	{
