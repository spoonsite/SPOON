		...
		extends LookupEntity<SecurityPermission>
{
	...
	protected Map<String, LookupEntity> systemCodeMap()
	{
		...
		codeMap.put(ADMIN_ENTRY_VERSION_CREATE, newLookup(SecurityPermission.class, ADMIN_ENTRY_VERSION_CREATE, "Allows the admin to create a snapshot of the version", null, GROUPBY_ENTRY_MANAGEMENT, ADMIN_ENTRY_READ));
