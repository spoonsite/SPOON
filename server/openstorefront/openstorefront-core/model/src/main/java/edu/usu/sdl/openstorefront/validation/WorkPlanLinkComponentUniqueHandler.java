 ...
 * @author dshurtleff
 */
public class WorkPlanLinkComponentUniqueHandler
		implements UniqueHandler<WorkPlanLink>
{
	...
	public boolean isUnique(Field field, Object value, WorkPlanLink fullDataObject)
	{
		...
		existing.setComponentId(fullDataObject.getComponentId());
	...
	{
		return "Entry may only be associated with one workflow at a time";
	}
