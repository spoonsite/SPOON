		...
		extends LookupEntity<WorkPlanStepActionType>
{
	...
	public static final String ASSIGN_ENTRY_TYPE_GROUP = "ASSIGN_ENTRY_TYPE_GROUP";
	...
	protected Map<String, LookupEntity> systemCodeMap()
	{
		...
		codeMap.put(ASSIGN_ENTRY_TYPE_GROUP, newLookup(WorkPlanStepActionType.class, ASSIGN_ENTRY_TYPE_GROUP, "Assign Entry to Entry Type Group"));
