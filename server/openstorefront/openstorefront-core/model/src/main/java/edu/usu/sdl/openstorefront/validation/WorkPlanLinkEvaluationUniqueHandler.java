 ...
 * @author dshurtleff
 */
public class WorkPlanLinkEvaluationUniqueHandler
		implements UniqueHandler<WorkPlanLink>
{
	...
	public boolean isUnique(Field field, Object value, WorkPlanLink fullDataObject)
	{
		...
		existing.setEvaluationId(fullDataObject.getEvaluationId());
	...
	{
		return "Evaluation may only be associated with one workflow at a time";
	}
