...
/**
 * This check to Manager Connection (Mongo is expected to running)
 *
 * @author dshurtleff
 */
public class MongoDBManagerUseCase
{

	//private static final Logger LOG = Logger.getLogger(MongoDBManagerUseCase.class.getName());
	@Test
