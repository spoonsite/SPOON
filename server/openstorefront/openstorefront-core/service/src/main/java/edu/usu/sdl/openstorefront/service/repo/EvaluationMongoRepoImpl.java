		...
		implements EvaluationRepo
{
	...
	public ChecklistQuestionWrapper findChecklistQuestions(CheckQuestionFilterParams filterQueryParams)
	{
		...
		specialOperatorModel = new SpecialOperatorModel<>();
		ChecklistQuestion checklistInExample = new ChecklistQuestion();
		checklistInExample.setTags(new ArrayList<>());

		specialOperatorModel.setExample(checklistInExample);
		specialOperatorModel.getGenerateStatementOption().setParameterValues(filterQueryParams.getTags());
