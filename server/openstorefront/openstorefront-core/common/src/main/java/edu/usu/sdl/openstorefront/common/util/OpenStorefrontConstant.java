...
public class OpenStorefrontConstant
{
	...
	public static final int FIELD_SIZE_ORGANIZATION = 255;
	public static final int FIELD_SIZE_CODE = 100;
	public static final int FIELD_SIZE_PHONE = 80;
	public static final int FIELD_SIZE_DESCRIPTION = 500;
	public static final int FIELD_SIZE_COMPONENT_NAME = 500;
	public static final int FIELD_SIZE_COMPONENT_DESCRIPTION = 32000;
	public static final int FIELD_SIZE_GUID = 40;
	public static final int FIELD_SIZE_GENERAL_TEXT = 500;
