		...
		submissionPanel.requiredAttributeStore = Ext.create('Ext.data.Store', {
			...
			listeners: {
				datachanged: function (store) {
					if (submissionPanel.requiredAttributeStore.ignore)
						return;
				...
				},
				{
					...
					items: [
						...
						},
						{
							...
							title: 'Additional Attributesasdf <i class="fa fa-question-circle"  data-qtip="Attributes are filterable metadata about the entry."></i>',
							collapsible: true,
							titleCollapse: true,
							margin: '0 0 20 0',
							frame: true,
