<%-- 
    ...
    Author     : dshurtleff
--%>
<%@page import="com.samaxes.filter.util.HTTPCacheHeader"%><%@page import="java.util.logging.Level"%><%@page import="java.util.logging.Logger"%><%@page import="org.apache.shiro.subject.Subject"%><%@page import="java.util.Enumeration"%><%@page import="edu.usu.sdl.openstorefront.common.manager.PropertiesManager"%><%@page import="edu.usu.sdl.openstorefront.security.HeaderAuthToken"%><%@page import="edu.usu.sdl.openstorefront.security.HeaderRealm"%><%@page import="org.apache.shiro.realm.Realm"%><%@page import="org.apache.shiro.web.mgt.DefaultWebSecurityManager"%><%@page import="org.apache.shiro.SecurityUtils"%><%@page import="edu.usu.sdl.openstorefront.web.init.ShiroAdjustedFilter"%><%@page  import="edu.usu.sdl.openstorefront.security.SecurityUtil" %><%@page contentType="text/html" pageEncoding="UTF-8"%><%
	out.clear();
