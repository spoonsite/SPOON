	...
	initComponent: function () {
					...
					items: [
						...
						},
						{
							...
							store: {
								...
								proxy: {
									type: 'ajax',
									url: '/openstorefront/api/v1/resource/lookuptypes/IntegrationType'
								}
							}
						},						
						{
							...
							store: {
								...
								proxy: {
									type: 'ajax',
									url: '/openstorefront/api/v1/resource/attributes/attributexreftypes/detail/distinct'
								}
							}
						},
						{
		...
		var loadJiraIssue = function() {
			...
			if (issueField.getValue()) {
				...
				Ext.Ajax.request({
					url: '/openstorefront/api/v1/service/jira/ticket/' + issueField.getValue(),
					callback: function(){
