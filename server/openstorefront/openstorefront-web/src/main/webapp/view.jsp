				...
				items: [				
					{
						...
						tpl: new Ext.XTemplate(
							...
							'Contact Vendor: <div style="font-weight: bold; color: #555555;"><tpl if="contacts.length &lt; 1">support@spoonsite.com</tpl><tpl for="contacts"><tpl if="[xindex] == \'1\'">{email}</tpl></tpl></div>',
							'</div>',
							'  <tpl for="attributes">',
