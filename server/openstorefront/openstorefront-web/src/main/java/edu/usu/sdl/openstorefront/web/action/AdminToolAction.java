		...
		extends BaseToolAction
{
	...
	public Map<String, PageModel> getPageMap()
	{
		...
		pageMap.put("Partial-Submissions", new PageModel("/WEB-INF/securepages/admin/data/partialSubmissions.jsp", new String[]{SecurityPermission.ADMIN_PARTIAL_SUBMISSIONS}));
