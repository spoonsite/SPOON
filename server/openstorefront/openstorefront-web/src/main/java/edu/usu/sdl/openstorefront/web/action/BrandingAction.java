		...
		extends BaseAction
{
	...
	public Resolution generalMedia() throws FileNotFoundException
	{
		...
		if (generalMedia == null) {
			...
			return new StreamingResolution("image/png")
			{
				...
				{
					try (InputStream in = BrandingAction.class.getResourceAsStream(MISSING_IMAGE)) {
	...
	public Resolution defaultHandle() throws FileNotFoundException {
		...
		LOG.log(Level.FINE, MessageFormat.format("Branding not found, nothing returned", name));
		return new ErrorResolution(404);		
	}
