 ...
 * @author ccummings
 */
public class SystemSearchClient
		extends AbstractService
{

	private String basePath = "api/v1/resource/systemsearches";

	public SystemSearchClient(ClientAPI client)
	{
		super(client);
	}

	public Response activateSearch(String searchId)
	{
		throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
	}

	public SystemSearch createNewSearch(SystemSearch search)
	{
		APIResponse response = client.httpPost(basePath, search, null);
		return response.getResponse(SystemSearch.class);
	}
	...
	public Response updateSearch(String searchId, SystemSearch search)
	{
		throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
	}
