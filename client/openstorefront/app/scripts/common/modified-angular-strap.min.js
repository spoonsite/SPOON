...
// The typeahead feature in this modified version of angular strap has been edited
// to return undefined when ($typeahead.select) is emmitted and there was no selection
// made by the user. This is so that we can catch the case where no input was made
// and the input field was empty when the user pressed enter.
  ...
  function ($window, $rootScope, $compile, $q, $templateCache, $http, $animate, dimensions, $$rAF) {
    ...
    function TooltipFactory(element, config) {
      var $tooltip = {};
        // Common vars
        var nodeName = '';
        if (element[0] && element[0].nodeName){
        ...
        $tooltip.init = function () {
          ...
          angular.forEach(triggers, function (trigger) {
            ...
            } else if (trigger !== 'manual' && typeof element !== 'string' ) {
  ...
  'mgcrea.ngStrap.helpers.parseOptions'
    ...
    function ($window, $rootScope, $tooltip) {
      ...
      function TypeaheadFactory(element, controller, config) {
        ...
        scope.$select = function (index, evt) {
          console.log('we hit the scope select');
        ...
        $typeahead.select = function (index) {
          // console.log('scope.$matches.index', scope.$matches[index].value);
          ...
          if (index >= 0) {
            ...
            if (parentScope)
              ...
              scope.$emit('$typeahead.select', controller.$viewValue, -1);
            }
          };
        // Protected methods
    ...
    return {
      ...
      link: function postLink(scope, element, attr, controller) {
        ...
        controller.$render = function () {
          ...
          selected = angular.isObject(selected) ? (selected.label? selected.label: selected.name) : selected;
