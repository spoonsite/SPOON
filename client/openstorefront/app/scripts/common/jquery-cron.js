    ...
    var methods = {
        init : function(opts) {
            ...
            block["period"] = $("<span class='cron-period'>"
                    + "Every <select class='form-control' style='width:auto; display:inline-block' name='cron-period'>" + custom_periods
            ...
            block["dom"] = $("<span class='cron-block cron-block-dom'>"
                    + " on the <select class='form-control' style='width:auto; display:inline-block' name='cron-dom'>" + str_opt_dom
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["month"] = $("<span class='cron-block cron-block-month'>"
                    + " of <select class='form-control' style='width:auto; display:inline-block' name='cron-month'>" + str_opt_month
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["mins"] = $("<span class='cron-block cron-block-mins'>"
                    + " at <select class='form-control' style='width:auto; display:inline-block' name='cron-mins'>" + str_opt_mih
            ...
            block["dow"] = $("<span class='cron-block cron-block-dow'>"
                    + " on <select class='form-control' style='width:auto; display:inline-block' name='cron-dow'>" + str_opt_dow
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["time"] = $("<span class='cron-block cron-block-time'>"
                    + " at <select class='cron-time-hour form-control' style='width:auto; display:inline-block' name='cron-time-hour'>" + str_opt_hid
                    + "</select>:<select class='cron-time-min form-control' style='width:auto; display:inline-block' name='cron-time-min'>" + str_opt_mih
                    + " </span>")
                .appendTo(this)
                .data("root", this);
