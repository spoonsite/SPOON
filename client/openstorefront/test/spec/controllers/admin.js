...
// Does not work on arrays {} and []
   ...
   expect(scope.data).toEqual([
       ...
       { label: 'Integrations', location:'views/admin/configuration/default.html', toolTitle:'Integration Management', detailedDesc: 'Allows for the configuration of data integration with external systems such as JIRA',  key:'integration' },
       { label: 'Imports', location:'views/admin/application_management/manageImports.html', toolTitle:'Import Management', detailedDesc: 'Allows for management of the data imports and their mappings',  key:'imports' },
   ...
   expect(scope.systemTools).toEqual([
       ...
       { label: 'Branding', location: 'views/admin/application_management/manageBranding.html', toolTitle: 'Branding Template Management', detailedDesc: 'Allows the ability to set the graphic design and theme characteristics for the site.', key: 'BRANDING' },
