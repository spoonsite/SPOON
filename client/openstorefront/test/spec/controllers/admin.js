...
// Does not work on arrays {} and []
   ...
   expect(scope.data).toEqual([
       { label: 'Articles', location: 'views/admin/editlanding.html', toolTitle: 'Manage Articles', detailedDesc: 'Articles, also called topic landing pages, are detail pages of topics of interest with optional related listings.  Articles are assigned to an Attribute Code which allows for searching and filter by topic. ', key: 'landing' }, 
       { label: 'Attributes', location: 'views/admin/editattributes.html', children: [  ], toolTitle: 'Manage Attributes', detailedDesc: 'Attributes are used to categorize components and other listings.  They can be searched on and  filtered.  They represent the metadata for a listing.  Attribute Types represent a category and a code respresents a specific value.  The data is linked by the type and code which allows for a simple change of the description.', key: 'attributes', parentKey: null, data: undefined }, 
       { label: 'Components', location: 'views/admin/editcomponents.html', toolTitle: 'Manage Components', detailedDesc: 'Components represent the main listing item in the application.  This tool allows for manipulating all data related to a component.', key: 'components' }, 
       { label: 'Highlights', location: 'views/admin/edithighlights.html', toolTitle: 'Manage Highlights', detailedDesc: 'Allows for the configuration of highlights that show up on the front page', key: 'highlights' },
   ...
   expect(scope.systemTools).toEqual([
       ...
       { label: 'System', location: 'views/admin/manageSystem.html', toolTitle: 'System Management', detailedDesc: 'Allows for viewing system status and managing system properties', key: 'SYSTEM' }, 
       { label: 'Tracking', location: 'views/admin/tracking.html', toolTitle: 'Manage Tracking', detailedDesc: 'Track system, user, and component data.', key: 'tracking' }, 
       { label: 'User Messages', location: 'views/admin/manageUserMessages.html', toolTitle: 'User Message Management', detailedDesc: 'User messages are queued messages for users.  This primary usage is for watches.  This tool allows for viewing of queued message as well as viewing of archived messages. ', key: 'USER_MESSAGE' } ]);
