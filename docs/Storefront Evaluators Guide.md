...
Entries that have been added to storefront, and been approved, can be evaluated. Entries can be added via user submission from the User Tools area and then approved by an administrator, or directly added by an administrator. Go [here](HTML TBD) for a quick overview of how to submit a new entry.
...
For our example below we created templates based on the information [here](HTML TBD).
...
![Repository Details Pre Evaluation][HTML TBD]
...
![Evaluations Info Page][HTML TBD]
...
**Entry**
  ...
  2. Attributes
      ...
      Ultimately, attributes become Entry Vitals on the Details tab for an entry. Here is an example: ![Entry Details][HTML TBD]
      
  3. Relationships
      ![Entry Relationships][HTML TBD]
  ...
  4. Contacts
      ...
      Ultimately, contacts become Points of Contact on the Details tab for an entry. Here is an example: ![Entry Details][HTML TBD]
      
  5. Resources
      ![Entry Resources][HTML TBD]
      ...
      Ultimately, resources become Location of Entry Artifacts on the Details tab for an entry. Here is an example: ![Entry Details][HTML TBD]
      
  6. Media
      ![Entry Media][HTML TBD]
...
Details
![Details Page for Contoso Repository][HTML TBD]
![Entry Details][HTML TBD]

Evaluation
![Evaluation Page for Contoso Repository][HTML TBD]