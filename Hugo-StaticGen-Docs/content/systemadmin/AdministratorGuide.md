...
Configure LDAP, OpenAM, and application properties.
...
| external.usermanager                | Specifies the manager that is used for external user management( IniRealmManager or LdapUserManager) | IniRealmManager              |
...
|                                     |                                                                                                      |                              |
| **Security**                        |                                                                                                      |                              |
| role.admin                          | Set this before strarting the application the first time to set the name of the Admin Role           | STOREFRONT-Admin             |
|                                     |                                                                                                      |                              |
...
| jira.server.url                     |                                                                                                      | https://jira.di2e.net        |
|                                     |                                                                                                      |                              |
| **Job management**                  |                                                                                                      |                              |
...
| userreview.autoapprove              | Allows user reviews, questions, and answers submitted by users to be automatically approved          | true                         |
...
|                                     |                                                                                                      |                              |
| **Help**                            |                                                                                                      |                              |
| help.url                            | The URL that hosts this documentation                                                                | https://spoonsite.github.io/ |
